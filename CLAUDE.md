...
- **Gió lốc** (`Skills/GioLoc.cs`, hình `Vfx/VfxGioLoc.cs`, hiệu ứng `Combat/BiHatTung.cs`, 16/09/2026): 3 lốc nhỏ toả quạt 11°. **Hình dựng bằng
  ...
  `GioDai`/`GioSoi`, flipbook `BuiDenCuon`; chân to thêm 30% so với gốc, nhỏ dần về 0 ở 2 m), xám trắng như Lốc xoáy, **xoáy MỘT chiều đi lên** (mọi lớp quay âm quanh +Y + UV trượt âm — chiều
