...
**Menu `Diablo 2.5D`** trong Unity (54 mục): 1 nướng asset + dựng màn, 3 tự kiểm tra,
...
- **Act2 có 10 lò lửa đá** (cùng prefab `LoLuaDa`, nhóm gốc `LoLua_Act2`, có va chạm) do **menu 54** đặt: lò giữa = chỗ
  ...
  lại menu 54 rồi 54b, đừng kéo tay.
