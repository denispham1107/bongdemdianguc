...
public partial class GameHUD : MonoBehaviour
{
    ...
    Texture2D iconBinhMau, iconBinhMana, iconCauBang, iconGioLoc, iconLuaDiaNguc, iconTangHinh;
    GUIStyle kieuSoBinh;
    ...
    /// <summary>Bieu tuong moi ky nang, xep theo SO HIEU ky nang (0..12).</summary>
