...
public partial class GameHUD : MonoBehaviour
{
    ...
    Texture2D iconBinhMau, iconBinhMana, iconCauBang, iconGioLoc, iconLuaDiaNguc;
    GUIStyle kieuSoBinh;
    ...
    /// <summary>Bieu tuong moi ky nang, xep theo SO HIEU ky nang (0..11).</summary>
    public Texture2D[] BoIcon()
    {
        return new Texture2D[] { iconFire, iconIce, iconBolt, iconWind,
                                 iconMeteor, iconKhieng, iconGiatSet, iconBinhMau, iconBinhMana, iconCauBang, iconGioLoc, iconLuaDiaNguc };
    }
    ...
    float HoiChieu01(int skill)
    {
        ...
        switch (skill)
        {
            ...
            case CapDo.KyLuaDiaNguc: return player.LuaDiaNgucCooldown01;
