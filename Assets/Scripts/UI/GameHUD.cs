...
public partial class GameHUD : MonoBehaviour
{
    ...
    Texture2D iconBinhMau, iconBinhMana, iconCauBang, iconGioLoc, iconLuaDiaNguc, iconTangHinh, iconCauDien;
    GUIStyle kieuSoBinh;
    ...
    /// <summary>Bieu tuong moi ky nang, xep theo SO HIEU ky nang (0..13).</summary>
