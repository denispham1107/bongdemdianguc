...
public struct TrangThaiNhanVat
{
    ...
    public float hoiCauLua, hoiBang, hoiSet, hoiLoc, hoiThienThach, hoiKhieng, hoiGiatSet, hoiCauBang, hoiGioLoc, hoiLuaDiaNguc, hoiTangHinh, hoiCauDien, hoiHoaLocXoay, hoiTocBien, hoiMayGiong;
